report 50196 "Batch Post Sales Orders 2"
{
    ...
    dataset
    {
        dataitem("Sales Header";"Sales Header")
        {
            ...
            trigger OnPreDataItem()var SalesBatchPostMgt: Codeunit "Sales Batch Post Mgt.";
            begin
                ...
                "Sales Header".SetFilter("No.", NoFilter1);
                CurrReport.Break();
            end;
        }
    }
    requestpage
    {
                ...
                group(Options)
                {
                    ...
                    field(ReplacePostingDate;ReplacePostingDate)
                    {
                        ...
                        trigger OnValidate()begin
                            if ReplacePostingDate then Message(Text003);
                        end;
                    }
                    ...
                    field(CalcInvDisc;CalcInvDisc)
                    {
                        ...
                        trigger OnValidate()var SalesReceivablesSetup: Record "Sales & Receivables Setup";
                        begin
                    ...
                    field(PrintDoc;PrintDoc)
                    {
                        ...
                        begin
                            if PrintDoc then begin
                                SalesReceivablesSetup.Get();
                                if SalesReceivablesSetup."Post with Job Queue" then SalesReceivablesSetup.TestField("Post & Print with Job Queue");
                            end;
                        end;
                    }
                }
        ...
        trigger OnOpenPage()var SalesReceivablesSetup: Record "Sales & Receivables Setup";
    ...
    var Text003: Label 'The exchange rate associated with the new posting date on the sales header will not apply to the sales lines.';
    ShipReq: Boolean;
    InvReq: Boolean;
    PostingDateReq: Date;
    ...
    local procedure OnAfterOnOpenPage(var ShipReq: Boolean;
    var InvReq: Boolean;
    var PostingDateReq: Date;
    var ReplacePostingDate: Boolean;
    var ReplaceDocumentDate: Boolean;
    var CalcInvDisc: Boolean)begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnBeforeSalesBatchPostMgt(var SalesHeader: Record "Sales Header";
    var ShipReq: Boolean;
    var InvReq: Boolean)begin
    end;
}
