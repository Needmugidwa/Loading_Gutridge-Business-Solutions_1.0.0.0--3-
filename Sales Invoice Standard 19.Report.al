report 50135 "Noic Sales - Invoice "
{
    RDLCLayout = './Sales Invoice Standard.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(PDocumentCopyText; STRSUBSTNO(DocumentCaption, CopyText))
            {
    ...
    var
        ...
        SalesInvoiceNoLbl: label 'Sales Invoice';
